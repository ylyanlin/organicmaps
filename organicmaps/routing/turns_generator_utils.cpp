...
{
  //__android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "InvertDirection called");
  switch (dir)
  {
...
CarDirection RightmostDirection(double const angle)
{
  ...
  //__android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_*][%ld] RightmostDirection called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
...
CarDirection LeftmostDirection(double const angle)
{
  //timespec ts;
  //clock_gettime(CLOCK_MONOTONIC, &ts);
  //__android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_2][%ld] LeftmostDirection called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
