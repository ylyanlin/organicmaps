...
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_1][%ld] GetVehicleType called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
...
void RoutingManager::OnBuildRouteReady(Route const & route, RouterResultCode code)
{
  timespec ts;
  clock_gettime(CLOCK_MONOTONIC, &ts);
  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_0][%ld] OnBuildRouteReady called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
...
void RoutingManager::OnRoutePointPassed(RouteMarkType type, size_t intermediateIndex)
{
  timespec ts;
  clock_gettime(CLOCK_MONOTONIC, &ts);
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[%ld] OnRoutePointPassed called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
  // Remove route point.
...
void RoutingManager::OnLocationUpdate(location::GpsInfo const & info)
{
  timespec ts;
  clock_gettime(CLOCK_MONOTONIC, &ts);
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_3][%ld] OnLocationUpdate called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
...
vector<RouteMarkData> RoutingManager::GetRoutePoints() const
{
  timespec ts;
  clock_gettime(CLOCK_MONOTONIC, &ts);
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_4][%ld] GetRoutePoints called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
  vector<RouteMarkData> result;
  RoutePointsLayout routePoints(*m_bmManager);
...
void RoutingManager::SetUserCurrentPosition(m2::PointD const & position)
{
  timespec ts;
  clock_gettime(CLOCK_MONOTONIC, &ts);
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_5][%ld] SetUserCurrentPosition called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
                                          ...
                                          location::RouteMatchingInfo & routeMatchingInfo)
{
  timespec ts;
  clock_gettime(CLOCK_MONOTONIC, &ts);
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_6][%ld] MatchLocationToRoute called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
  if (!IsRoutingActive())
    return;
...
location::RouteMatchingInfo RoutingManager::GetRouteMatchingInfo(location::GpsInfo & info)
{
  timespec ts;
  clock_gettime(CLOCK_MONOTONIC, &ts);
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_7][%ld] GetRouteMatchingInfo called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
...
bool RoutingManager::IsSpeedCamLimitExceeded() const
{
    timespec ts;
    clock_gettime(CLOCK_MONOTONIC, &ts);
//    __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_8][%ld] IsSpeedCamLimitExceeded called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
