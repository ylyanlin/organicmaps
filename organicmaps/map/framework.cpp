...
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_11][%ld] OnLocationUpdate called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
...
void Framework::OnCompassUpdate(CompassInfo const & info)
{
  timespec ts;
  clock_gettime(CLOCK_MONOTONIC, &ts);
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_12][%ld] OnCompassUpdate called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
...
void Framework::OnUserPositionChanged(m2::PointD const & position, bool hasPosition)
{
  timespec ts;
  clock_gettime(CLOCK_MONOTONIC, &ts);
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_*][%ld] OnUserPositionChanged called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
...
void Framework::OnViewportChanged(ScreenBase const & screen)
{
  ...
  timespec ts;
  clock_gettime(CLOCK_MONOTONIC, &ts);
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_14][%ld] Framework::OnViewportChanged called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
...
void Framework::TouchEvent(df::TouchEvent const & touch)
{
  timespec ts;
  clock_gettime(CLOCK_MONOTONIC, &ts);
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_16][%ld] TouchEvent called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
                                     ...
                                     string & distance, double & azimut)
{
  ...
  timespec ts;
  clock_gettime(CLOCK_MONOTONIC, &ts);
//  __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_17][%ld] GetDistanceAndAzimut called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
