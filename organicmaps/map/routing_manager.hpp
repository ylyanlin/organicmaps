...
//    __android_log_print(ANDROID_LOG_INFO, "SIDECHANNEL_DEBUG", "[MethodId_10][%ld] IsRoutingActive called", (long)(ts.tv_sec * 1000000) + (ts.tv_nsec / 1000));
  ...
  bool IsRoutingFollowing() const {
    return m_routingSession.IsFollowing();
  }
