...
public enum TtsPlayer implements Initializable<Context>
{
  ...
  {
//    i("SIDECHANNEL_DEBUG", "[MethodId_11]" + "[" + System.nanoTime() / 1000 + "]" + " speak called");
  ...
  {
    //i("SIDECHANNEL_DEBUG", "[MethodId_4]" + "[" + System.nanoTime() / 1000 + "]" + " playTurnNotifications called");
  ...
  {
    //i("SIDECHANNEL_DEBUG", "playTurnNotifications2");
    if (MediaPlayerWrapper.from(context).isPlaying())
      return;
