...
final class RoutingBottomMenuController implements View.OnClickListener
{
  ...
  void setStartButton()
  {
    ...
    mStart.setOnClickListener(v -> {
      ...
      //Log.i("SIDECHANNEL_DEBUG", "[MethodId_0]" + "[" + System.nanoTime() / 1000 + "]" + " setStartButton called");
    });
  ...
  {
    Log.i("SIDECHANNEL_DEBUG", "[MethodId_10]" + "[" + System.nanoTime() / 1000 + "]" + " showRoutingDetails called");
