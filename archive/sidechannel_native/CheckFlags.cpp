...
such as Java_com_mapswithme_maps_sidechannel_SideChannelJob_GetPattern to get the activated pattern etc.
*/
...
Java_com_mapswithme_maps_sidechannel_SideChannelJob_CacheCheck(JNIEnv *env, jobject thiz) {
...
extern "C" JNIEXPORT jintArray JNICALL
Java_com_mapswithme_maps_sidechannel_SideChannelJob_GetT(JNIEnv *env, jobject thiz) {
...
extern "C" JNIEXPORT jintArray JNICALL
Java_com_mapswithme_maps_sidechannel_SideChannelJob_GetPattern(JNIEnv *env, jobject thiz, jint c) {
...
Java_com_mapswithme_maps_sidechannel_SideChannelJob_ClearPattern(JNIEnv *env, jobject thiz, jint c) {
    pthread_mutex_lock(&g_lock);
    if (c == 1)
...
extern "C" JNIEXPORT jintArray JNICALL
Java_com_mapswithme_maps_sidechannel_SideChannelJob_addr(JNIEnv *env, jobject thiz) {
    jintArray ja = env->NewIntArray(compiler_position);
    jint *arr = env->GetIntArrayElements(ja, NULL);
    if (addr != NULL) {
...
Java_com_mapswithme_maps_sidechannel_CacheScan_GetTimes(JNIEnv *env, jobject thiz) {
    length = log_length;
...
extern "C" JNIEXPORT jlongArray JNICALL
Java_com_mapswithme_maps_sidechannel_CacheScan_GetAddresses(JNIEnv *env, jobject thiz) {
...
extern "C" JNIEXPORT jintArray JNICALL
Java_com_mapswithme_maps_sidechannel_SideChannelJob_GetThresholds(JNIEnv *env, jobject thiz) {
    if (length != 0) {
        jintArray ja = env->NewIntArray(length);
        jint *arr = env->GetIntArrayElements(ja, NULL);
...
extern "C" JNIEXPORT jintArray JNICALL
Java_com_mapswithme_maps_sidechannel_CacheScan_GetLogs(JNIEnv *env, jobject thiz) {
...
extern "C" JNIEXPORT jlongArray JNICALL
Java_com_mapswithme_maps_sidechannel_CacheScan_GetTimingCounts(JNIEnv *env, jobject thiz) {
...
//Java_com_mapswithme_maps_sidechannel_SideChannelJob_GetTimingCount(JNIEnv *env, jobject thiz) {
...
/*
extern "C" JNIEXPORT jintArray JNICALL
Java_com_mapswithme_maps_sidechannel_SideChannelJob_thd(JNIEnv *env, jobject thiz){
...
*/
extern "C" JNIEXPORT void JNICALL
Java_com_mapswithme_maps_sidechannel_SideChannelJob_HandleCapture(JNIEnv *env, jobject thiz, jint i) {
    pthread_mutex_lock(&g_lock);
    flags[i] = 0;
    pthread_mutex_unlock(&g_lock);
}
...
extern "C" JNIEXPORT void JNICALL
Java_com_mapswithme_maps_sidechannel_SideChannelJob_increase(JNIEnv *env, jobject thiz) {
    threshold += 5;
}

extern "C" JNIEXPORT void JNICALL
Java_com_mapswithme_maps_sidechannel_SideChannelJob_decrease(JNIEnv *env, jobject thiz) {
    threshold -= 5;
}

extern "C" JNIEXPORT void JNICALL
Java_com_mapswithme_maps_sidechannel_SideChannelJob_setthreshold(JNIEnv *env, jobject thiz, jint new_thresh) {
    threshold = new_thresh;
}

extern "C" JNIEXPORT jint JNICALL
Java_com_mapswithme_maps_sidechannel_CacheScan_getthreshold(JNIEnv *env, jobject thiz) {
    return threshold;
}

/*
extern "C" JNIEXPORT void JNICALL
Java_com_mapswithme_maps_sidechannel_SideChannelJob_filteraddr(JNIEnv *env, jobject thiz, jint index){
    pthread_mutex_lock(&g_lock);
    addr[index] = 0;
    pthread_mutex_unlock(&g_lock);
}
