...
#include <dlfcn.h>
#include "fakedl.h"
#include <oatparser/oat/OATParser.h>
#include <dexinfo.h>
#include <sys/mman.h>
...
jobjectArray Decompress(JNIEnv* env,jstring jstr){
    jclass jniclass = (*env).FindClass("com/tritop/androsense2/CacheScan");
    if (NULL == jniclass) {
...
//    std::string test_oat = "/data/app/~~BB-vA7qXu3RTmOnbg9z9hg==/de.tcrass.minos-2MHAAyKgevL7Ukh95mm_XA==/oat/arm64/base.odex";
//    read_file = test_oat;
...
//    jstring jstr = env->NewStringUTF("/data/app/~~BB-vA7qXu3RTmOnbg9z9hg==/de.tcrass.minos-2MHAAyKgevL7Ukh95mm_XA==/base.apk");//turn to jstring
